import { RiskAnalysis, IRiskAnalysis, RiskAnalysisZodSchema } from '../models/riskAnalysis.model.js';
...
export class AnalysisService {
  ...
  async getAnalysisByContractId(contractId: string): Promise<IRiskAnalysis | null> {
