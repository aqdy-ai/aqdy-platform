...
<head>
  ...
  <style>
    ...
    .section {
      margin-bottom: 35px;
      padding-bottom: 35px;
      border-bottom: 1px dashed #272d3d;
    }
    .section.last {
      margin-bottom: 0;
      padding-bottom: 0;
  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <div class="section arabic">
        ...
        <p>مرحباً ${name}،</p>
        <p>شكرًا لتسجيلك في منصة عقدي. يرجى الضغط على الزر أدناه لتأكيد بريدك الإلكتروني وتفعيل حسابك بالكامل. هذا الرابط صالح لمدة 24 ساعة.</p>
        <div class="btn-container">
          <a href="${verificationUrl}" class="btn" target="_blank">تأكيد الحساب</a>
        </div>
      </div>
      ...
      <div class="section english last">
        ...
        <p>Hello ${name},</p>
        <p>Thank you for registering on Aqdy. Please click the button below to verify your email address and activate your account. This link will expire in 24 hours.</p>
        <div class="btn-container">
    ...
    <div class="footer">
      <p>&copy; ${new Date().getFullYear()} Aqdy. All rights reserved.</p>
      <p>عقدي - المساعد القانوني الذكي للقرارات الآمنة</p>
    </div>
  </div>
</body>
</html>
    ...
    if (this.transporter) {
      ...
      // Dev / testing fallback console logger
      logger.info(`
=========================================
