...
describe("Plans Router Integration Tests", () => {
    beforeAll(async () => {
        ...
        const mongoURI = process.env.MONGODB_URI || "mongodb://127.0.0.1:27017/aqdy_test";
    ...
    test("GET /api/plans should retrieve all active plans sorted by price", async () => {
        ...
        const freePlan = res.body.data.find((p) => p.slug === "free");
...
//# sourceMappingURL=plans.integration.test.js.map