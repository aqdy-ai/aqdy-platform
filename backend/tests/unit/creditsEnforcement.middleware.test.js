...
const mockCalculateAnalysisCost = jest.fn();
...
const { enforceCreditsBeforeAnalysis } = await import("../../src/middlewares/creditsEnforcement.middleware.js");
// ── Helpers ────────────────────────────────────────────────────────────────
const mockReq = (userId, contractId, extras = {}) => ({
...
//# sourceMappingURL=creditsEnforcement.middleware.test.js.map