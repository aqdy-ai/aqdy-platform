...
const { ContractHistoryService } =
  await import("../../src/services/contractHistory.service.js");
...
describe("ContractHistoryService - getContractDetail", () => {
  ...
  test("should return contract with analysis", async () => {
    ...
    const result = await service.getContractDetail(
      validContractId,
      validUserId,
    );
...
describe("ContractHistoryService - softDeleteContract", () => {
  ...
  test("should soft delete contract successfully", async () => {
    ...
    const result = await service.softDeleteContract(
      validContractId,
      validUserId,
    );
