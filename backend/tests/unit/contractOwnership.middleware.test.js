...
const { verifyContractOwnership } = await import("../../src/middlewares/contractOwnership.middleware.js");
const mockReq = (userId, contractId, fromParams = false) => ({
    user: { _id: userId },
...
//# sourceMappingURL=contractOwnership.middleware.test.js.map