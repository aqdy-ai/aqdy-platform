...
RiskAnalysis.findOne = mockFindOne;
RiskAnalysis.find = mockFind;
...
describe("AnalysisService", () => {
    ...
    describe("triggerAnalysis() — success", () => {
        ...
        test("should call orchestratorService.run with the correct arguments", async () => {
            await analysisService.triggerAnalysis("contract_abc", "user_xyz", "Contract text here.", "en");
            expect(mockRun).toHaveBeenCalledTimes(1);
            expect(mockRun).toHaveBeenCalledWith("contract_abc", "user_xyz", "Contract text here.", "en");
        });
    ...
    describe("triggerAnalysis() — retry behavior", () => {
        test("should retry transient orchestrator failures and succeed", async () => {
            ...
            await retryService.triggerAnalysis("contract_retry", "user_retry", "Contract text here.", "en");
        ...
        test("should write ANALYSIS_FAILED after exhausting retries", async () => {
            ...
            await expect(retryService.triggerAnalysis("contract_fail", "user_retry", "Some text.", "en")).resolves.toBeUndefined();
            expect(mockRun).toHaveBeenCalledTimes(2);
...
//# sourceMappingURL=analysis.service.test.js.map