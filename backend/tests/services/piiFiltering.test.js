...
describe("PII Filtering Service", () => {
    ...
    describe("Edge Cases & False Positives", () => {
        ...
        test("should handle multiple PII types in the same string", () => {
            const input = "Contact 01012345678 or test@example.com. SSN: 123-45-6789. Card: 4123 4567 8901 2345.";
            const expected = "Contact [REDACTED] or [REDACTED]. SSN: [REDACTED]. Card: [REDACTED].";
            expect(redactPII(input)).toBe(expected);
        });
        test("should not break clause extraction or contract structure", () => {
            const input = "Clause 1.2: The employee (ID: 29001011234567) shall be paid $1000.";
            const expected = "Clause 1.2: The employee (ID: [REDACTED]) shall be paid $1000.";
            expect(redactPII(input)).toBe(expected);
        });
...
//# sourceMappingURL=piiFiltering.test.js.map