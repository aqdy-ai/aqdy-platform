    ...
    <div className="flex min-h-[80vh] flex-col items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="bg-card/40 border-border/50 w-full max-w-md space-y-8 rounded-3xl border p-8 shadow-2xl backdrop-blur-md">
        ...
        <div className="space-y-4">
          ...
          <button
            onClick={logout}
            className="group border-border/60 text-foreground relative flex w-full items-center justify-center gap-2 rounded-xl border px-4 py-3 text-sm font-bold shadow-sm transition-all hover:cursor-pointer hover:border-rose-500/30 hover:bg-rose-500/10 hover:text-rose-500 focus:ring-2 focus:ring-rose-500/20 focus:outline-none"
          >
